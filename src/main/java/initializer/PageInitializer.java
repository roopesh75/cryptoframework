...
public class PageInitializer extends BrowserInitializer {
	...
	public void initializePages(BrowserDriver driver, Class testClass) {
		...
		assignmentManagementPage=(AssignmentManagementPage)PageFactory.getPage(AssignmentManagementPage.class, driver);
		addAnAssignmentDefinitionPage=(AddAnAssignmentDefinitionPage)PageFactory.getPage(AddAnAssignmentDefinitionPage.class, driver);
		...
		addQuestionCustomExamPage=(AddQuestionCustomExamPage) PageFactory.getPage(AddQuestionCustomExamPage.class, driver);
		controlDocumentTrainingPage=(ControlDocumentTrainingPage) PageFactory.getPage(ControlDocumentTrainingPage.class, driver);
