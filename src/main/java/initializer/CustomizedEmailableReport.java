...
public class CustomizedEmailableReport implements IReporter {
    ...
    private Collection<ITestNGMethod> getMethodSet(IResultMap tests,
        ...
        for (IInvokedMethod im : invokedMethods) {
            //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("suite.getAllInvokedMethods()  .."+im);
            if (tests.getAllMethods().contains(im.getTestMethod())) {
                r.add(im);
            }
        }
        //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("r ....."+ r.toString());
        //Arrays.sort(r.toArray(new IInvokedMethod[r.size()]), new TestSorter());
        Collections.sort(r,new TestSorter());

        //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("Sorted Array .."+r.toString());
        ...
        //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("All methods before sort"+ allMethods.toString());
        Collections.sort(allMethods, new TestMethodSorter());
        //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("After sorting "+allMethods.toString());

        //for (ITestNGMethod m : tests.getAllMethods()) {
        for (ITestNGMethod m : allMethods) {
            //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("tests.getAllMethods()  .."+m);
            if (!result.contains(m)) {
                result.add(m);
            }
        }
        //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("results ....."+ result.toString());
        return result;
    }
    ...
    private class TestSorter implements Comparator<IInvokedMethod> {
        ...
        public int compare(IInvokedMethod o1, IInvokedMethod o2) {
            //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("Comparing " + ((ITestNGMethod) o1).getMethodName() + " " + o1.getDate() + " and " + ((ITestNGMethod) o2).getMethodName() + " " + o2.getDate());
            //return (int) (o1.getDate() - o2.getDate());
            //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("First method class name "+o1.getTestMethod().getTestClass().getName());
            //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("second method class name "+o2.getTestMethod().getTestClass().getName());
            int r =o1.getTestMethod().getTestClass().getName().compareTo(o2.getTestMethod().getTestClass().getName());
            //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("class name compare "+ r);
            if (r == 0) {
                //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("First method name "+o1.getTestMethod());
                //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("second method name "+o2.getTestMethod());
    ...
    private class TestMethodSorter implements Comparator<ITestNGMethod> {
        ...
        public int compare(ITestNGMethod o1, ITestNGMethod o2) {
            //return (int) (o1.getDate() - o2.getDate());
            //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("First method class name "+o1.getTestClass().getName());
            //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("second method class name "+o2.getTestClass().getName());
            int r =o1.getTestClass().getName().compareTo(o2.getTestClass().getName());
            //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("class name compare "+ r);
            if (r == 0) {
                //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("First method name "+o1.getMethodName());
                //logger.info("ThreadID: "+Thread.currentThread().getId()+"  "+Thread.currentThread().getName()+" "+("second method name "+o2.getMethodName());
