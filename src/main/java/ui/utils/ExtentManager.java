...
public class ExtentManager {
	...
	public static synchronized ExtentReports createInstance(String fileName, String projectName) {
		...
		ExtentXReporter extentXReporter = new ExtentXReporter(Config.getREPORTINGSERVER().split(":")[0]);
		extentXReporter.config().setServerUrl("http://" + Config.getREPORTINGSERVER());
		extentXReporter.config().setReportName(new SimpleDateFormat("dd/MMM/yyyy HH:mm:ss a").format(Calendar.getInstance().getTime()));
