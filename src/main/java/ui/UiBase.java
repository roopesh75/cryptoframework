...
public class UiBase {
    ...
    public static final String NETCONTROL_BAR_IFRAME = "NetControlBar";
    ...
    public void netControlIframeSwitch(){
    	switchToDefaultFrame();
		switchToFrame(NETCONTROL_BAR_IFRAME);
    }
    public void popUpIframeSwitch(){
    	switchToDefaultFrame();
   ...
   /* public Boolean isDisplayed(List<WebElement> element) {
    ...
    public BrowserElement scrollToView(BrowserElement we) {
        executeJavaScript("arguments[0].scrollIntoView(true);", we);
        return we;
    }
