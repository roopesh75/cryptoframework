...
public class TestCase19576 extends BaseTest {


    @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser", description = 
    		"Users_UserGroup_AND/OR relationship between multiple values of UserId and contains criteria", groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_AND_OR_relationship_between_multiple_values_of_UserId_and_contains_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_USER_ID"), getData("GENERIC.OPERATOR_CONTAINS"), getData("TC19576.VALUE_CONTAINS1")).
                addCriteria(getData("GENERIC.CRITERIA_USER_ID"), getData("GENERIC.OPERATOR_CONTAINS"), getData("TC19576.VALUE_CONTAINS2"));
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == false &&
                ...
                "'contains' operator criteria super-chip for 'Match All Conditions' unchecked.");
    }
