...
public class TestCase19571 extends BaseTest {
    private static final Logger logger = Logger.getLogger(TestCase19571.class);

    @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser", description = 
    		"Users_UserGroup_OR relationship between multiple values of UserId and not equal to criteria", groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_OR_relationship_between_multiple_values_of_UserId_and_not_equals_to_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_USER_ID"), getData("GENERIC.OPERATOR_NOT_EQUALS_TO"), getData("TC19571.VALUE_USER1")).
                addCriteria(getData("GENERIC.CRITERIA_USER_ID"), getData("GENERIC.OPERATOR_NOT_EQUALS_TO"), getData("TC19571.VALUE_USER2"));
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == true &&
                ...
                "'User Id' and 'not equal to' operator criteria super-chip for 'Match All' checked.");
        ...
        groupManagementPage.openEditGroupCriteria().selectMatchAllConditions(false).
                addCriteria(getData("GENERIC.CRITERIA_USER_ID"), getData("GENERIC.OPERATOR_NOT_EQUALS_TO"), getData("TC19571.VALUE_USER1")).
                addCriteria(getData("GENERIC.CRITERIA_USER_ID"), getData("GENERIC.OPERATOR_NOT_EQUALS_TO"), getData("TC19571.VALUE_USER2"));
        //6
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == false &&
                ...
                "'not equal to' operator criteria super-chip for 'Match All Conditions' unchecked.");
    }
