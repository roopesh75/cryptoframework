...
public class TestCase19598 extends BaseTest {

    @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser",description = "Users_UserGroup_AND/OR"
    		+ " relationship between multiple values of a date custom field and between criteria",groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_AND_OR_relationship_between_multiple_values_of_a_date_custom_field_and_between_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_BETWEEN"),
                getData("TC19598.VALUE_BT1"),getData("TC19598.VALUE_BT2")).addCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_BETWEEN"),
                        getData("TC19598.VALUE_BT3"),getData("TC19598.VALUE_BT4"));
        ...
        //1
        Assert(groupManagementPage.getUserCount().matches(RegularExpression.NUMBER), "Group Information screen of the user group "
        		+ "will be displayed with the user count.");
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == true &&
                editGroupCriteriaPage.getOperatorForCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD")).
                        get(0).matches(getData("GENERIC.OPERATOR_BETWEEN")) &&
                editGroupCriteriaPage.
                        getRelationshipForCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD")).get(0).
                        matches(getData("GENERIC.RELATIONSHIP_AND")), "An \"and\"  relationship is displayed for the chips of the 'date" +
                " custom field' and 'between' operator criteria super-chip for 'Match All Conditions' checked.");
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == false &&
                ...
                editGroupCriteriaPage.
                        getRelationshipForCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD")).get(0).
                        matches(getData("GENERIC.RELATIONSHIP_OR")), "An \"or\"  relationship is displayed for the chips of the 'date custom field' " +
                "and 'between' operator criteria super-chip for 'Match All Conditions' unchecked.");
    }
}