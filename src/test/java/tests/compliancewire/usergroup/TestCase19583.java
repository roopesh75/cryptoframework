...
public class TestCase19583 extends BaseTest {

    @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser",description = "Users_UserGroup_AND/OR relationship between multiple values of an alphanumeric custom field and does not end with criteria",
            groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_AND_OR_relationship_between_multiple_values_of_an_alphanumeric_custom_field_and_does_not_end_with_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_ALPHANUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_NOT_ENDS_WITH"), getData("TC19583.VALUE_FOOD_NOT_ENDS_WITH1")).
                addCriteria(getData("GENERIC.CRITERIA_ALPHANUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_NOT_ENDS_WITH"), getData("TC19583.VALUE_FOOD_NOT_ENDS_WITH2"));
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == true &&
                ...
                " and 'does not end with' operator criteria super-chip for 'Match All Conditions' checked.");
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == false &&
                ...
                "and 'does not end with' operator criteria super-chip for 'Match All Conditions' unchecked.");
    }
