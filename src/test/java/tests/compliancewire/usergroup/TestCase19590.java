...
public class TestCase19590 extends BaseTest {

    @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser",description = "Users_UserGroup_AND/OR relationship between multiple values of a numeric custom field and less than criteria",groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_AND_OR_relationship_between_multiple_values_of_a_numeric_custom_field_and_less_than_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_NUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_LESS_THAN"), getData("TC19590.VALUE_LT1")).
                addCriteria(getData("GENERIC.CRITERIA_NUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_LESS_THAN"), getData("TC19590.VALUE_LT2"));
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == true &&
                ...
                "and 'less than' operator criteria super-chip for 'Match All Conditions' checked.");
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == false &&
                ...
                editGroupCriteriaPage.
                        getRelationshipForCriteria(getData("GENERIC.CRITERIA_NUMERIC_CUSTOM_FIELD")).get(0).
                        matches(getData("GENERIC.RELATIONSHIP_OR")), "An \"or\"  relationship is displayed for the chips of the 'numeric custom field' and 'less than' " +
