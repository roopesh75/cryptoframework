...
public class TestCase19594 extends BaseTest {
    ...
    public void Users_UserGroup_AND_OR_relationship_between_multiple_values_of_a_numeric_custom_field_and_greater_than_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_GREATER_THAN"), getData("TC19594.VALUE_GT1")).
                addCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_GREATER_THAN"), getData("TC19594.VALUE_GT2"));
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == true &&
                ...
                editGroupCriteriaPage.
                        ...
                        matches(getData("GENERIC.RELATIONSHIP_AND")), "An \"and\"  relationship is displayed for the chips of the 'date custom field' and" +
                " 'greater than' operator criteria super-chip for 'Match All Conditions' checked.");
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == false &&
                ...
                " 'date custom field' and 'greater than' operator criteria super-chip for 'Match All Conditions' unchecked.");
    }
