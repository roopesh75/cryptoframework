...
public class TestCase19592 extends BaseTest {

    @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser",description = "Users_UserGroup_OR relationship between multiple values of a " +
            "date custom field and equals to criteria",groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_OR_relationship_between_multiple_values_of_a_date_custom_field_and_equals_to_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_EQUALS_TO"), getData("TC19592.VALUE_DATE1")).
                addCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_EQUALS_TO"), getData("TC19592.VALUE_DATE2"));
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == true &&
                ...
                " 'date custom field' and 'equals to' operator criteria super-chip for 'Match All Conditions' checked");
        ...
        groupManagementPage.openEditGroupCriteria().selectMatchAllConditions(false).
                addCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_EQUALS_TO"), getData("TC19592.VALUE_DATE1")).
                addCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_EQUALS_TO"), getData("TC19592.VALUE_DATE2"));
        //6
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == false &&
                ...
                editGroupCriteriaPage.
                        getRelationshipForCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD")).get(0).
                        matches(getData("GENERIC.RELATIONSHIP_OR")), "An \"or\"  relationship is displayed for the chips of the " +
                "'date custom field' and 'equals to' operator criteria super-chip for 'Match All Conditions' unchecked.");
