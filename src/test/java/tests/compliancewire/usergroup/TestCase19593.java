...
public class TestCase19593 extends BaseTest {
    ...
    @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser",description = "Users_UserGroup_OR relationship "
    		+ "between multiple values of a date custom field and not equal to criteria",groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_OR_relationship_between_multiple_values_of_a_date_custom_field_and_not_equal_to_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_NOT_EQUALS_TO"), getData("TC19593.VALUE_DATE1")).
                addCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_NOT_EQUALS_TO"), getData("TC19593.VALUE_DATE2"));
        ...
        groupManagementPage.openEditGroupCriteria().selectMatchAllConditions(false).
                addCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_NOT_EQUALS_TO"), getData("TC19593.VALUE_DATE1")).
                addCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_NOT_EQUALS_TO"), getData("TC19593.VALUE_DATE2"));
        //6
