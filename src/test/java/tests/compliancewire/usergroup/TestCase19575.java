...
public class TestCase19575 extends BaseTest {


    @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser", description = "Users_UserGroup_AND/OR relationship between multiple values of 'User Id' and does not end with criteria", groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_AND_OR_relationship_between_multiple_values_of_User_Id_and_does_not_end_with_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_USER_ID"), getData("GENERIC.OPERATOR_NOT_ENDS_WITH"), getData("TC19575.VALUE_USER_NOT_ENDS_WITH1")).
                addCriteria(getData("GENERIC.CRITERIA_USER_ID"), getData("GENERIC.OPERATOR_NOT_ENDS_WITH"), getData("TC19575.VALUE_USER_NOT_ENDS_WITH2"));
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == true &&
                editGroupCriteriaPage.getOperatorForCriteria(getData("GENERIC.CRITERIA_USER_ID")).
                        get(0).matches(getData("GENERIC.OPERATOR_NOT_ENDS_WITH")) &&
                ...
                "'does not end with' operator criteria super-chip for 'Match All Conditions' checked.");
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == false &&
                ...
                "'does not end with' operator criteria super-chip for 'Match All Conditions' unchecked.");
    }
