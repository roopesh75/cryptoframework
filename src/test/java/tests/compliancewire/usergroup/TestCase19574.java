...
public class TestCase19574 extends BaseTest {
    private static final Logger logger = Logger.getLogger(TestCase19574.class);

    @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser", description = "Users_UserGroup_AND/OR relationship between multiple values of UserId and ends with criteria", groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_AND_OR_relationship_between_multiple_values_of_UserId_and_ends_with_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_USER_ID"), getData("GENERIC.OPERATOR_ENDS_WITH"), getData("TC19574.VALUE_USER_ENDS_WITH1")).
                addCriteria(getData("GENERIC.CRITERIA_USER_ID"), getData("GENERIC.OPERATOR_ENDS_WITH"), getData("TC19574.VALUE_USER_ENDS_WITH2"));
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == true &&
                editGroupCriteriaPage.getOperatorForCriteria(getData("GENERIC.CRITERIA_USER_ID")).
                        get(0).matches(getData("GENERIC.OPERATOR_ENDS_WITH")) &&
                ...
                " and 'ends with' operator criteria super-chip for 'Match All Conditions' checked.");
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == false &&
                ...
                editGroupCriteriaPage.
                        getRelationshipForCriteria(getData("GENERIC.CRITERIA_USER_ID")).get(0).
                        matches(getData("GENERIC.RELATIONSHIP_OR")), "An \"or\"  relationship is displayed for the chips of the 'User Id' and " +
                "'ends with' operator criteria super-chip for 'Match All Conditions' unchecked.");
    }
