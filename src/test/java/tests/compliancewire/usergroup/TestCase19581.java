...
public class TestCase19581 extends BaseTest {

    @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser",description = "Users_UserGroup_AND/OR relationship between multiple values of an alphanumeric custom field and does not begin with criteria"
            ,groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_AND_OR_relationship_between_multiple_values_of_an_alphanumeric_custom_field_and_does_not_begin_with_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_ALPHANUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_NOT_BEGIN_WITH"), getData("TC19581.VALUE_FOOD_NOT_BEGINS1")).
                addCriteria(getData("GENERIC.CRITERIA_ALPHANUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_NOT_BEGIN_WITH"), getData("TC19581.VALUE_FOOD_NOT_BEGINS2"));
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == false &&
                ...
                editGroupCriteriaPage.
                        getRelationshipForCriteria(getData("GENERIC.CRITERIA_ALPHANUMERIC_CUSTOM_FIELD")).get(0).
                        matches(getData("GENERIC.RELATIONSHIP_OR")), "An \"or\"  relationship is displayed for the chips of the 'alphanumeric custom field' and" +
                " 'does not begin with' operator criteria super-chip for 'Match All Conditions' unchecked.");
    }
}