...
public class TestCase19596 extends BaseTest {

    @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser",description = "Users_UserGroup_AND/OR relationship between multiple values of a date custom field and less than criteria",groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_AND_OR_relationship_between_multiple_values_of_a_date_custom_field_and_less_than_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_LESS_THAN"), getData("TC19596.VALUE_LT1")).
                addCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_LESS_THAN"), getData("TC19596.VALUE_LT2"));
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == true &&
                editGroupCriteriaPage.getOperatorForCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD")).
                        get(0).matches(getData("GENERIC.OPERATOR_LESS_THAN")) &&
                editGroupCriteriaPage.
                        getRelationshipForCriteria(getData("GENERIC.CRITERIA_DATE_CUSTOM_FIELD")).get(0).
                        matches(getData("GENERIC.RELATIONSHIP_AND")), "An \"and\"  relationship is displayed for the chips of the" +
                " 'date custom field' and 'less than' operator criteria super-chip for 'Match All Conditions' checked.");
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == false &&
                ...
                "'date custom field' and 'less than' operator criteria super-chip for 'Match All Conditions' unchecked.");
    }
}