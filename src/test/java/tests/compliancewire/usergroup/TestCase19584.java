...
public class TestCase19584 extends BaseTest {

    @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser",description = "Users_UserGroup_AND/OR relationship between multiple " +
            "values of an alphanumeric custom field and contains criteria"
            ,groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_AND_OR_relationship_between_multiple_values_of_an_alphanumeric_custom_field_and_contains_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_ALPHANUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_CONTAINS"), getData("TC19584.VALUE_CONTAINS1")).
                addCriteria(getData("GENERIC.CRITERIA_ALPHANUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_CONTAINS"), getData("TC19584.VALUE_CONTAINS2"));
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == true &&
                editGroupCriteriaPage.getOperatorForCriteria(getData("GENERIC.CRITERIA_ALPHANUMERIC_CUSTOM_FIELD")).
                        get(0).matches(getData("GENERIC.OPERATOR_CONTAINS")) &&
                ...
                "and 'contains' operator criteria super-chip for 'Match All Conditions' checked.");
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == false &&
                ...
                "and 'contains' operator criteria super-chip for 'Match All Conditions' unchecked.");
    }
