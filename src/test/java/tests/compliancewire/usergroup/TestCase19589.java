...
public class TestCase19589 extends BaseTest {

    @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser",description = "Users_UserGroup_AND/OR relationship between multiple values of a numeric custom field and greater than or equal to criteria",
            groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_AND_OR_relationship_between_multiple_values_of_a_numeric_custom_field_and_greater_than_or_equal_to_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_NUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_GREATER_THAN_OR_EQUAL"), getData("TC19589.VALUE_GTE1")).
                addCriteria(getData("GENERIC.CRITERIA_NUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_GREATER_THAN_OR_EQUAL"), getData("TC19589.VALUE_GTE2"));
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == true &&
                ...
                editGroupCriteriaPage.
                        ...
                        matches(getData("GENERIC.RELATIONSHIP_AND")), "An \"and\"  relationship is displayed for the chips of the 'numeric custom field' and 'greater " +
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == false &&
                ...
                editGroupCriteriaPage.
                        getRelationshipForCriteria(getData("GENERIC.CRITERIA_NUMERIC_CUSTOM_FIELD")).get(0).
                        matches(getData("GENERIC.RELATIONSHIP_OR")), "An \"or\"  relationship is displayed for the chips of the 'numeric custom field' and 'greater " +
