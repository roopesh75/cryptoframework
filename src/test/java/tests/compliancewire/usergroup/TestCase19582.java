...
public class TestCase19582 extends BaseTest {

   @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser",description = "Users_UserGroup_AND/OR relationship between multiple values of an alphanumeric custom field and ends with criteria",
           groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_AND_OR_relationship_between_multiple_values_of_an_alphanumeric_custom_field_and_ends_with_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_ALPHANUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_ENDS_WITH"), getData("TC19582.VALUE_FOOD_ENDS_WITH1")).
                addCriteria(getData("GENERIC.CRITERIA_ALPHANUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_ENDS_WITH"), getData("TC19582.VALUE_FOOD_ENDS_WITH2"));
        ...
        Assert(editGroupCriteriaPage.getMatchConditionsState() == false &&
                ...
                " and 'ends with' operator criteria super-chip for 'Match All Conditions' unchecked.");
    }
