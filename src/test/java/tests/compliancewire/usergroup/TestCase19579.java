...
public class TestCase19579 extends BaseTest {

    @Test(alwaysRun=true,dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser",description = "Users_UserGroup_OR relationship between multiple values of an alphanumeric custom field and not equal to criteria", groups = {"USER_GROUP_CRITERIA"})
    public void Users_UserGroup_OR_relationship_between_multiple_values_of_an_alphanumeric_custom_field_and_not_equal_to_criteria(String userName) throws Exception {
        ...
        editGroupCriteriaPage.addCriteria(getData("GENERIC.CRITERIA_ALPHANUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_NOT_EQUALS_TO"), getData("TC19579.VALUE_FOOD1")).
                addCriteria(getData("GENERIC.CRITERIA_ALPHANUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_NOT_EQUALS_TO"), getData("TC19579.VALUE_FOOD2"));
        ...
        groupManagementPage.openEditGroupCriteria().selectMatchAllConditions(false).
                addCriteria(getData("GENERIC.CRITERIA_ALPHANUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_NOT_EQUALS_TO"), getData("TC19579.VALUE_FOOD1")).
                addCriteria(getData("GENERIC.CRITERIA_ALPHANUMERIC_CUSTOM_FIELD"), getData("GENERIC.OPERATOR_NOT_EQUALS_TO"), getData("TC19579.VALUE_FOOD2"));
        //6
