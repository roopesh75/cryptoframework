...
public class TestCase20237 extends BaseTest{
	...
	@Test(alwaysRun = true, dataProviderClass = DynamicDataProvider.class, dataProvider = "createAdminUser", description = "Edit"
			+ " information for any effective Control document.", groups = {
			"" })
	public void Edit_information_for_any_effective_Control_document(String userName) throws Exception {
		...
		addControlDocumentTraining(getFromStorage("Training1"),getFromStorage("Training1"),"Auto Polaris 2.0","www.google.com");
